...
class PickupCansel extends StatefulWidget {
  const PickupCansel({super.key});

  @override
  State<PickupCansel> createState() => _PickupCanselState();
}

class _PickupCanselState extends State<PickupCansel> {
  ...
  void initState() {
    super.initState();
    // Optionally open the keyboard when the screen is displayed
                  ...
                  onTap: () async {
                    if (newImage != '') {
                      if (remarkController.text.isNotEmpty) {
                        ...
                        notification().warning(context, 'remark is required');
                      }
                    } else {
  ...
  Future<void> _getCurrentLocation() async {
    ...
    if (res == 1) {
      newImage = '';
      Provider.of<ProviderS>(context, listen: false).readOnly = false;
      Navigator.pop(context);
