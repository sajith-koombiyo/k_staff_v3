...
import '../login_and_signup/otp.dart';
import '../widget/diloag_button.dart';
import '../widget/main_button.dart';

class AppAgreement extends StatefulWidget {
  const AppAgreement({Key? key}) : super(key: key);

  @override
  State<AppAgreement> createState() => _AppAgreementState();
}

class _AppAgreementState extends State<AppAgreement> {
...
""";
    ...
    return SafeArea(
      child: Scaffold(
        backgroundColor: Color.fromARGB(173, 63, 62, 62),
        appBar: AppBar(
          backgroundColor: Colors.transparent,
          title: Text(
            'Welcome to Koombiyo Delivery!',
          ...
          child: Scrollbar(
            ...
            child: SingleChildScrollView(
              child: Column(children: [
                ...
                DialogButton(
                  color: agree ? appliteBlue2 : Colors.grey,
                  buttonHeight: 50,
                  onTap: agree
                      ? () {
                          _doSomething();
